...
% Defining the file/lang formats we want.
...
% Document properties.
\title{Web-based Interactive Graphics with gridSVG}
\author{Simon Potter}
\date{June 19, 2011} % TODO: Change this date later
\hypersetup{pdftitle = {Web-based Interactive Graphics with gridSVG | Simon Potter},
        	pdfauthor = {Simon Potter}}
